...
device_parameter = input(f'Enter a parameter ({", ".join(london_co[device_name].keys())}): ')
print(london_co[device_name].get(device_parameter.lower(), 'There is no such parameter.'))